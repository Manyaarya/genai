...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/manya./repos/genai/venv/bin',
 'BINLIBDEST': '/Users/manya./repos/genai/venv/lib/python3.10',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/manya./repos/genai/venv/lib '
              '-L/Users/manya./repos/genai/venv/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           ...
           '-isystem '
           '/Users/manya./repos/genai/venv/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/manya./repos/genai/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/Users/manya./repos/genai/venv' "
                "'--build=arm64-apple-darwin20.0.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Users/manya./repos/genai/venv/share/zoneinfo:/Users/manya./repos/genai/venv/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Users/manya./repos/genai/venv/include' "
                "'--with-tcltk-libs=-L/Users/manya./repos/genai/venv/lib "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Users/manya./repos/genai/venv/include'",
 'CONFINCLUDEDIR': '/Users/manya./repos/genai/venv/include',
 'CONFINCLUDEPY': '/Users/manya./repos/genai/venv/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/manya./repos/genai/venv '
             '/Users/manya./repos/genai/venv/lib '
             '/Users/manya./repos/genai/venv/lib/python3.10 '
             '/Users/manya./repos/genai/venv/lib/python3.10/lib-dynload',
 'DESTLIB': '/Users/manya./repos/genai/venv/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/Users/manya./repos/genai/venv/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/manya./repos/genai/venv/include '
                   '/Users/manya./repos/genai/venv/include '
                   '/Users/manya./repos/genai/venv/include/python3.10 '
                   '/Users/manya./repos/genai/venv/include/python3.10',
 'INCLUDEDIR': '/Users/manya./repos/genai/venv/include',
 'INCLUDEPY': '/Users/manya./repos/genai/venv/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/Users/manya./repos/genai/venv/lib/python3.10',
 'LIBDIR': '/Users/manya./repos/genai/venv/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/manya./repos/genai/venv/lib/pkgconfig',
 'LIBPL': '/Users/manya./repos/genai/venv/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/manya./repos/genai/venv/lib/python3.10',
 ...
 'MANDIR': '/Users/manya./repos/genai/venv/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/manya./repos/genai/venv/include',
 'OPENSSL_LDFLAGS': '-L/Users/manya./repos/genai/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/manya./repos/genai/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/Users/manya./repos/genai/venv/include',
 'TCLTK_LIBS': '-L/Users/manya./repos/genai/venv/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/manya./repos/genai/venv/share/zoneinfo:/Users/manya./repos/genai/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/Users/manya./repos/genai/venv/share',
 'exec_prefix': '/Users/manya./repos/genai/venv',
 'prefix': '/Users/manya./repos/genai/venv',
